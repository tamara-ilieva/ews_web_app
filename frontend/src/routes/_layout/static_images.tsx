                    ...
                    <Tr key={image.id}>
                      ...
                      <Td>
                        <Button
                          ...
                          onClick={() => handleIsSickChange("static", image.id, !image.is_sick_human_input)}
                        >
                      ...
                      <Td>
                        <DiseaseDropdown
                          ...
                          onDiseaseChange={(disease_id) =>
                            handleDiseaseChange("static", image.id, { target: { value: disease_id } })
                          }
                        />
                      </Td>
