...
#     try:
#         with open("app/api/src/model_files/data.json", 'r') as f:
...
#     with open('app/api/src/model_files/labels.json', 'r') as lb:
#         labels = json.load(lb)
#
#     loaded_model = model
#     loaded_model.load_state_dict(torch.load("app/api/src/model_files/model2.pth"))
#     loaded_model.eval()
#
